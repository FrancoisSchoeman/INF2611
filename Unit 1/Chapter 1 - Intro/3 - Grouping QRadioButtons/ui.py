...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label.setGeometry(QtCore.QRect(20, 30, 351, 20))
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(Dialog)
        self.label_2.setGeometry(QtCore.QRect(24, 150, 351, 20))
        self.label_2.setObjectName("label_2")
        self.labelSelected = QtWidgets.QLabel(Dialog)
        self.labelSelected.setGeometry(QtCore.QRect(20, 249, 351, 51))
        self.labelSelected.setText("")
        self.labelSelected.setObjectName("labelSelected")
        self.verticalLayoutWidget = QtWidgets.QWidget(Dialog)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(30, 50, 160, 100))
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(30, 170, 160, 71))
